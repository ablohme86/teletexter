...
SRCS = src/cmd_args.c src/teletexter.c src/lcd_disp.c src/client.c src/server_commands.c src/messages.c src/ident.c src/server.c src/config.c src/log.c src/utils.c
OBJS = $(SRCS:.c=.o)
